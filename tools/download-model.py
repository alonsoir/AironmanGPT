...
class ModelDownloader:
    ...
    def get_session(self):
        ...
        if self.max_retries:
            ...
            session.mount(
                "https://huggingface.co", HTTPAdapter(max_retries=self.max_retries)
            )
    ...
    def get_output_folder(
        self, model, branch, is_lora, is_llamacpp=False, model_dir=None
    ):
        if model_dir:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output", type=str, default=None, help="Save the model files to this folder."
    )
    parser.add_argument(
        "--model-dir",
        type=str,
        default=None,
        help="Save the model files to a subfolder of this folder instead of the default one (text-generation-webui/models).",
    )
    parser.add_argument(
    ...
    if args.output:
        ...
        output_folder = downloader.get_output_folder(
            model, branch, is_lora, is_llamacpp=is_llamacpp, model_dir=args.model_dir
        )
